        ...
        <section className="py-16 px-6">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h1 className="text-4xl font-geist mb-6">Our Materials</h1>
              <p className="text-lg text-[#4F4F4F] max-w-3xl mx-auto">
                We carefully select and work with the finest natural stones, creating timeless pieces that 
                bring beauty and durability to your space.
              </p>
            </div>

            <div className="grid md:grid-cols-3 gap-12">
              <div className="text-center">
                <h2 className="text-xl font-geist mb-4">Natural Beauty</h2>
              ...
              <div className="text-center">
                <h2 className="text-xl font-geist mb-4">Quality Selection</h2>
                <p className="text-[#4F4F4F]">
              ...
              <div className="text-center">
                <h2 className="text-xl font-geist mb-4">Expert Craftsmanship</h2>
                <p className="text-[#4F4F4F]">
