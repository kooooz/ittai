    ...
    <div className="relative min-h-screen flex flex-col">
      ...
      <section className="relative h-screen">
        ...
        <div className="absolute inset-0 z-0">
          <Image src="/stone-kitchen-island.png" alt="Interior Design Hero" fill priority className="object-cover" />
        ...
        <div className="relative z-10 h-full flex items-center justify-center">
          <div className="text-center text-white p-6 max-w-3xl">
            <h1 className="text-[45px] font-bold mb-6 font-din-condensed leading-tight tracking-wide small-caps">
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            <div>
              <h2 className="text-3xl font-bold font-din-condensed">The beauty of mono blocks</h2>
            </div>
